    ...
    public class AuthController : MainController
    {
        ...
        public async Task<IActionResult> Registrar(RegisterUserViewModel registerUser)
        {
            ...
            var user = new IdentityUser
            {
                ...
                EmailConfirmed = true //Já garante que o email ta confirmado para login, porém o padrão é validar
            };
        ...
        public async Task<IActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            {
                NotificarErro("Usuário temporariamente bloqueado por número de tentativas inválidas");
